async function getData() {
    try {
        let resolve = await fetch("https://639b5256d51415019752662f.mockapi.io/skinCare")
        if (resolve.ok === true) {
            console.log(resolve)
...
async function addData(fArray) {
    try {
        let addFetchMe = await fetch('https://639b5256d51415019752662f.mockapi.io/skinCare', {
            method: 'POST',
            headers: {
...
async function deleteDataCard(id) {
    try {
        let deleteMe = await fetch(`https://639b5256d51415019752662f.mockapi.io/skinCare/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
...
async function patchData(pArray,id) {
    try {
        let patchFetchMe = await fetch(`https://639b5256d51415019752662f.mockapi.io/skinCare/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
