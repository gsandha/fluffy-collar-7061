async function getData() {
    try {
        let resolve = await fetch("https://63997e4116b0fdad773e785b.mockapi.io/makeup")
        if (resolve.ok === true) {
            console.log(resolve)
...
async function addData(fArray) {
    try {
        let addFetchMe = await fetch('https://63997e4116b0fdad773e785b.mockapi.io/makeup', {
            method: 'POST',
            headers: {
...
async function deleteDataCard(id) {
    try {
        let deleteMe = await fetch(`https://63997e4116b0fdad773e785b.mockapi.io/makeup/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
...
async function patchData(pArray,id) {
    try {
        let patchFetchMe = await fetch(`https://63997e4116b0fdad773e785b.mockapi.io/makeup/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
