async function getData() {
    try {
        let resolve = await fetch("https://639c531016d1763ab1465215.mockapi.io/Fragrance")
        if (resolve.ok === true) {
            console.log(resolve)
...
async function addData(fArray) {
    try {
        let addFetchMe = await fetch('https://639c531016d1763ab1465215.mockapi.io/Fragrance', {
            method: 'POST',
            headers: {
...
async function deleteDataCard(id) {
    try {
        let deleteMe = await fetch(`https://639c531016d1763ab1465215.mockapi.io/Fragrance/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
...
async function patchData(pArray,id) {
    try {
        let patchFetchMe = await fetch(`https://639c531016d1763ab1465215.mockapi.io/Fragrance/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
